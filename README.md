...
New-NetFirewallRule -DisplayName "PrimeLeaks Web Server" -Direction Inbound -LocalPort 3000 -Protocol TCP -Action Allow
```
...
**LEAKED by PrimeLeaks**

[Website](https://primeleaks.cc) • [Discord](https://discord.com/invite/wgnsTu24bg)
